...
class BootstrapperDriver(object):
	"""
	...
	each section is sent to a callback (BootstrapperDriver._data_handler)
	...
	2. In BootstrapperDriver._data_handler data is divided between text data and
	...
	def callbacks(self):
		"""
		"""
		print(datetime.datetime.now(),' - bootstrapper_driver.callbacks')
		return_dict = {}
