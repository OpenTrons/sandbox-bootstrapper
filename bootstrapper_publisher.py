...
class Publisher:
    ...
    def __init__(self, session=None):
        """
        """
        print(datetime.datetime.now(),' - bootstrapper_publisher.__init__:')
        print('\targs:',locals())
    ...
    def set_caller(self, session):
        """
        """
        print(datetime.datetime.now(),' - bootstrapper_publisher.set_caller:')
        print('\targs:',locals())
        self.caller = session
    ...
    def publish(self,topic,to,session_id,type_,name,message,param):
        """
        """
        print(datetime.datetime.now(),' - bootstrapper_publisher.publish:')
        print('\targs:',locals())
